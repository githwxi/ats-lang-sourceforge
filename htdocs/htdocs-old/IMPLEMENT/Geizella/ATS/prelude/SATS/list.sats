...
// some built-in static constants for list operations
...
fun{a:t@ype} foreach_list {f:eff} (f: !a -<f> void, xs: List a):<f> void
overload foreach with foreach_list
...
fun{a:t@ype} list_get_elt_at_opt (xs: List a, i: Nat):<> Option a
...
fun{a:t@ype} list_nth_opt (xs: List a, u: Nat):<> Option a
