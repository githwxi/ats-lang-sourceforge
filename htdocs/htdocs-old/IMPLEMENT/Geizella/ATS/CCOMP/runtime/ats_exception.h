...
extern __thread
ats_exception_frame_type *ats_exception_stack ;
#else
extern
ats_exception_frame_type *ats_exception_stack ;
#endif

#define ATS_CURRENT_FRAME (ats_exception_stack)
...
static inline
ats_void_type
ats_raise_exn (const ats_exn_ptr_type exn) { ATS_RAISE(exn) ; }
...
extern
ats_void_type ats_match_failure(void) ;
