...
static /* inline */
ats_ptr_type
atspre_tostring_int (ats_int_type i0) {
  int i, n ;
  char *res ;
  ...
  res = ats_malloc_gc(n+1) ; res = res + n;
...
static /* inline */
ats_ptr_type
atspre_tostring_uint (ats_int_type i0) {
  int i, n ;
  char *res ;
