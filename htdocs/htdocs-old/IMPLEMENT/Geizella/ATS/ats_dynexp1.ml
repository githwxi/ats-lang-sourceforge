...
and fprint_pat1_list (out: out_channel) (p1ts: pat1 list): unit =
...
let pat1_list loc (npf: int) (p1ts: pat1 list): pat1 =
  ...
  end else { pat1_loc= loc; pat1_node= PT1list (npf, p1ts); }
...
let pat1_tup loc (is_flat: bool) (npf: int) (p1ts: pat1 list): pat1 =
...
and dec1_dyncst = {
  ...
  dec1_dyncst_extern: string option;
}
...
and dec1_impl = {
  ...
  dec1_impl_decarg: sarg1 list list;
  dec1_impl_def: dexp1;
}
...
and fprint_dexp1_list (out: out_channel) (d1es: dexp1 list): unit =
  fprint_list_with_sep fprint_dexp1 out d1es ","

and fprint_dexp1_list_list (out: out_channel) (d1ess: dexp1 list list): unit =
...
let dexp1_app_sta loc (d1e: dexp1) (sa1s: sexparg1 list): dexp1 =
  { dexp1_loc= loc; dexp1_node= DE1app_sta (d1e, sa1s); }

let dexp1_arr loc (s1e: sexp1) (d1es: dexp1 list): dexp1 =
...
let dexp1_lam_dyn loc
  (is_lin: bool) (p1t: pat1) (d1e: dexp1): dexp1 = {
    dexp1_loc= loc;
    dexp1_node= DE1lam_dyn (is_lin, p1t, d1e);
  }

let dexp1_lam_met loc (s1es: sexp1 list) (d1e: dexp1): dexp1 = {
  dexp1_loc= loc; dexp1_node= DE1lam_met (s1es, d1e);
}

let dexp1_lam_sta_ana loc (arg: sarg1 list) (d1e: dexp1): dexp1 = {
  dexp1_loc= loc; dexp1_node= DE1lam_sta_ana (arg, d1e);
}

let dexp1_lam_sta_syn loc (s1qs: squas1) (d1e: dexp1): dexp1 = {
...
let dexp1_rec loc (is_flat: bool) (ld1es: labdexp1 list): dexp1 = {
...
let dexp1_sel loc (is_ptr: int) (d1e: dexp1) (d1l: dlab1): dexp1 =
...
let datsrtcon1 loc (name: sid) (arg: srt1 list): datsrtcon1 = {
  datsrtcon1_loc= loc;
  datsrtcon1_name= name;
  datsrtcon1_arg= arg;
}

let dec1_datsrt loc (name: srt_id) (arg: srtarg list) (con: datsrtcon1 list)
  : dec1_datsrt = {
    dec1_datsrt_loc= loc;
...
let dec1_stacon loc
  (name: sid) (arg: (sid option * srt1 * int) list option) (def: sexp1 option)
  : dec1_stacon = {
    dec1_stacon_loc= loc;
...
let dec1_stacons loc (s1t: srt1) (ds: dec1_stacon list): dec1 = {
  dec1_loc= loc; dec1_node= DC1stacons (s1t, ds);
}

let dec1_stacst loc (name: sid) (arg: (srt1 list) list) (s1t: srt1)
  : dec1_stacst = {
    dec1_stacst_loc= loc;
...
let dec1_dyncst loc
  ...
  (s1e: sexp1) (ext: string option): dec1_dyncst = {
  dec1_dyncst_loc= loc;
  dec1_dyncst_name= name;
  dec1_dyncst_filename= filename;
  dec1_dyncst_sexp= s1e;
  dec1_dyncst_extern= ext;
}

let dec1_dyncsts loc
  (dck: dcstkind) (s1qss: squas1 list) (ds: dec1_dyncst list): dec1 = {
...
let dec1_sexpdefs loc (os1t: srt1 option) (ds: dec1_sexpdef list)
  : dec1 = {
    dec1_loc= loc; dec1_node= DC1sexpdefs (os1t, ds)
  }

let moditemdec1_sexpdefs loc (os1t: srt1 option) (ds: dec1_sexpdef list)
  : moditemdec1 = {
    moditemdec1_loc= loc;
    moditemdec1_node= MID1sexpdefs (os1t, ds);
}
...
let moditemdec1_typedefrecs loc (ds: dec1_sexpdef list)
  : moditemdec1 = {
    moditemdec1_loc= loc;
    moditemdec1_node= MID1typedefrecs ds;
}
...
let dec1_data loc
  ...
  (ds1: dec1_dat list) (ds2: dec1_sexpdef list)
  : dec1 = {
    dec1_loc= loc;
    dec1_node= DC1data (dtk, arg, ds1, ds2);
  }
...
let mtitemdec1_sexpdefs loc (ds: dec1_sexpdef list): mtitemdec1 = {
  mtitemdec1_loc= loc; mtitemdec1_node= MTID1sexpdefs ds;
}

let mtitemdec1_typedefs loc (ds: dec1_sexpdef list): mtitemdec1 = {
  mtitemdec1_loc= loc; mtitemdec1_node= MTID1typedefs ds;
}

let mtitemdec1_typedefrecs loc (ds: dec1_sexpdef list): mtitemdec1 = {
  mtitemdec1_loc= loc; mtitemdec1_node= MTID1typedefrecs ds;
}

let dec1_modtype loc (name: sid) (def: mtitemdec1 list)
  : dec1_modtype = {
    dec1_modtype_loc= loc;
...
let dec1_modtypes loc (is_prop: bool) (ds: dec1_modtype list)
  : dec1 = {
...
let dec1_overload loc (name: did) (id: dqual_opt_id): dec1 =
  { dec1_loc= loc; dec1_node= DC1overload (name, id); }

let dec1_macdef loc (name: did) (arg: (did list) list) (def: dexp1)
  : dec1_macdef = {
    dec1_macdef_loc = loc;
...
let dec1_macdefs loc (is_simple: bool) (ds: dec1_macdef list)
  : dec1 = {
    dec1_loc = loc;
    dec1_node = DC1macdefs (is_simple, ds);
  }

let dec1_var loc (name: did) (os1e: sexp1 option) (od1e: dexp1 option)
  : dec1_var = {
    dec1_var_loc= loc;
    dec1_var_name= name;
    dec1_var_type= os1e;
...
let dec1_vars loc (is_stack: bool) (ds: dec1_var list): dec1 = {
...
let moditemdec1_vals loc (vk: valkind) (ds: dec1_val list)
  : moditemdec1 = {
...
let dec1_fun loc (name: did) (def: dexp1) (ann: sexp1 option): dec1_fun = {
  dec1_fun_loc= loc; dec1_fun_name= name; dec1_fun_def= def; dec1_fun_ann= ann;
}
...
let dec1_impl loc (name: dqual_opt_id)
  (decarg: sarg1 list list) (def: dexp1): dec1_impl = {
  dec1_impl_loc= loc;
  dec1_impl_name= name;
  dec1_impl_decarg= decarg;
  dec1_impl_def= def;
}

let dec1_impls loc (ds: dec1_impl list): dec1 = {
  dec1_loc= loc; dec1_node= DC1impls ds;
}
