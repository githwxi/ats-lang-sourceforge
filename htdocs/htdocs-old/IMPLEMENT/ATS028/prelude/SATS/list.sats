...
//
fun{} list_is_nil
  {a:t@ype} {n:int} (xs: list (a, n)):<> bool (n==0)
fun{} list_is_cons
  {a:t@ype} {n:int} (xs: list (a, n)):<> bool (n > 0)
...
*)
fun{a:t@ype}
list_quicksort {env:viewtype} {n:int}
