...
fun malloc_ngc_err {n:nat} (n: int n)
  :<> [l:addr] (option_v (@(free_ngc_v l, bytes_v (n, l)), l <> null) | ptr l)
  = "ats_malloc_ngc_err"
...
fun calloc_ngc_err
  {a:viewtype} {n:nat} (n: int n, tsz: sizeof_t a)
  :<> [l:addr] (option_v (@(free_ngc_v l, @[a?][n] @ l), l <> null) | ptr l)
  = "ats_calloc_ngc_err"
