...
fun foreach_array_ptr_tsz_cloptr {a:viewt@ype} {n:nat} {f:eff} (
    f: !((&a) -<cloptr,f> void)
  , base: &(@[a][n])
  , asz: int n
  , tsz: sizeof_t a
...
fun iforeach_array_ptr_tsz_cloptr {a:viewt@ype} {n:nat} {f:eff} (
    f: !((natLt n, &a) -<cloptr,f> void)
  , base: &(@[a][n])
  , asz: int n
  , tsz: sizeof_t a
  ) :<f> void
...
fun array {a:viewt@ype} {n:nat} (arrsz: arraysize (a, n)):<> array (a, n)
...
fun array_size {a:viewt@ype} {n:nat} (A: array (a, n)):<> int n

fun length_array {a:viewt@ype} {n:nat} (A: array (a, n)):<> int n
overload length with length_array
...
fun{a:t@ype} foreach_array_cloptr {n:nat} {f:eff} (
    f: !(a -<cloptr,f> void)
  , A: array (a, n)
  ) :<f,!ref> void
...
fun{a:t@ype} iforeach_array_cloptr {n:nat} {f:eff} (
    f: !((natLt n, a) -<cloptr,f> void)
  , A: array (a, n)
  ) :<f,!ref> void
...
typedef Array (a:viewt@ype) = [n:nat] array (a, n)

(* ****** ****** *)

fun{a:t@ype} array_get_elt_at_exn
  (A: Array a, i: Nat):<!exn,!ref> a

fun{a:t@ype} array_set_elt_at_exn
  (A: Array a, i: Nat, x: a):<!exn,!ref> void
