...
let sexp2_is_array (s2e: sexp2): bool =
  match s2e.sexp2_node with SE2array _ -> true | _ -> false
...
let un_sexp2_at_viewt0ype_addr_view (s2e: sexp2): (sexp2 * sexp2) option =
  match At_viewt0ype_addr_view.un_make_exp s2e with
    | None -> None
    | Some [s2e1; s2e2] -> Some (s2e1, s2e2)
    | _ -> error_of_deadcode
	"ats_stacst2: un_sexp2_at_viewt0ype_addr_view"
...
module Uint_t0ype: Scst2Type =
  Scst2Fun (struct let name = "unsigned_int_t0ype" end)
module Uint_int_t0ype: Scst2Type =
  Scst2Fun (struct let name = "unsigned_int_int_t0ype" end)
...
module Uint_long_t0ype: Scst2Type =
  Scst2Fun (struct let name = "unsigned_int_long_t0ype" end)
...
module Uint_long_long_t0ype: Scst2Type =
  Scst2Fun (struct let name = "unsigned_int_long_long_t0ype" end)

module Int_short_t0ype: Scst2Type =
  Scst2Fun (struct let name = "int_short_t0ype" end)
module Uint_short_t0ype: Scst2Type =
  Scst2Fun (struct let name = "unsigned_int_short_t0ype" end)
...
module Uint_short_short_t0ype: Scst2Type =
  Scst2Fun (struct let name = "unsigned_int_short_short_t0ype" end)
...
module Arraysize_viewt0ype_int_viewt0ype: Scst2Type =
  Scst2Fun (struct let name = "arraysize_viewt0ype_int_viewt0ype" end)

let sexp2_arraysize_viewt0ype_int_viewt0ype (s2e_elt: sexp2) (n: int) =
  Arraysize_viewt0ype_int_viewt0ype.make_exp (Some [s2e_elt; sexp2_int n])
...
module Printf_c_types_type: Scst2Type =
  Scst2Fun (struct let name = "printf_c" end)
...
(*
  scst2_leq_table_add (Float_t0ype.make_cst ()) (Double_t0ype.make_cst ());
  scst2_leq_table_add (Double_t0ype.make_cst ()) (Double_long_t0ype.make_cst ());
*)
