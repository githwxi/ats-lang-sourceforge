...
static inline
ats_int_type
atslib_socket_domain_type (socket_domain d, socket_type t) {
  int res ;
  res = socket(d, t, 0) ;
  if (res < 0) {
    perror("socket");
...
static inline
ats_int_type
atslib_bind_inet_any_port_err(ats_int_type fd, ats_int_type port)
{
  int res ;
...
static inline
ats_void_type
atslib_bind_inet_any_port(ats_int_type fd, ats_int_type port)
{
  int res ;
...
static inline
ats_int_type
atslib_listen_err(ats_int_type fd, ats_int_type backlog) {
  return listen (fd, backlog) ;
}

static inline
ats_void_type
atslib_listen(ats_int_type fd, ats_int_type backlog) {
...
static inline
ats_int_type
atslib_accept_inet(ats_int_type fd) {
  int res ;
...
static inline
ats_void_type
atslib_socket_close(ats_int_type fd) {
  int res =  close(fd) ;
  if (res < 0) {
    perror("close") ;
