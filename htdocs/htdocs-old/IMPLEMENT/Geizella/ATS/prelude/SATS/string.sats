...
fun strbuf_make_uninitialized {n:nat}
  (n: int n):<> [l:addr] (strbuf (n+1, n) @ l | ptr l)
  = "atspre_strbuf_make_uninitialized"

fun string_make_uninitialized {n:nat} (n: int n):<> string n
  = "atspre_strbuf_make_uninitialized"

overload strbuf_make with strbuf_make_uninitialized
overload string_make with string_make_uninitialized
...
fun strbuf_make_list_int {n:nat}
  (cs: list (char, n), n: int n):<> [l:addr] (strbuf (n+1, n) @ l | ptr l)
  = "atspre_strbuf_make_list_int"

fun string_make_list_int {n:nat}
  (cs: list (char, n), n: int n):<> string n
  = "atspre_strbuf_make_list_int"

overload strbuf_make with strbuf_make_list_int
overload string_make with string_make_list_int
...
fun strbuf_get_char_at
  {m,n:nat} (sb: !strbuf (m, n), i: natLt n):<> char
...
fun string_set_char_at {n:nat}
  (s: string n, i: natLt n, c: char):<> void
  = "atspre_strbuf_set_char_at"

overload [] with strbuf_set_char_at
overload [] with string_set_char_at

fun string_set_char_at_exn (s: string, i: Nat, c: char):<!exn> void
...
fun string_hash_33 (s: string):<> uInt 
